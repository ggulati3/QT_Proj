...
//    while (losses < 3 && wins == 0)
//    {

        Game Tic_Tac_Toe(l1);			//creates a game with layout as paramter
        Tic_Tac_Toe.play_game();        //runs game


//        while (Tic_Tac_Toe.get_count() < 9)
//        {
//            if (Tic_Tac_Toe.player_win() == true)
//            {
//                layoutt->removeWidget(ticgame);
//                layoutt->addWidget(winner, 0, 1);
//                wins++;
//             }
//            else if (Tic_Tac_Toe.computer_win() == true)
//            {
//                layoutt->removeWidget(ticgame);
//                layoutt->addWidget(loser, 0, 1);
//                losses++;
//            }
//        }

//        if ((Tic_Tac_Toe.player_win() == false && Tic_Tac_Toe.computer_win() == false) && Tic_Tac_Toe.get_count() == 9)
//        {
//            if (Tic_Tac_Toe.player_win() == true)
//            {
//                layoutt->removeWidget(ticgame);
...
//            }
//        }
//        Tic_Tac_Toe.draw_blank_board();
//    }

//    if(wins == 1)
//    {
//        layoutt->addWidget(win_game_button, 1, 2);
//    }
//    else if(losses == 3)
//    {
...
void Game::connections()
{
    ...
    QObject::connect(board, SIGNAL(quit()), board, SLOT(game_over()));
}
...
void vec::game_over()
{
    QWidget* win= new QWidget; win->show();
    finished = true;
}

void vec::check_game()
{
    if (player_win() == true || computer_win() == true)
    {
        finished = true;
        emit quit();
    }
...
//    for (int i=0; i < 10; i++)            //all 9 objects
//    {
//        layout->removeWidget((*board)[i]);        //remove each box from the layout
//    }
//}
