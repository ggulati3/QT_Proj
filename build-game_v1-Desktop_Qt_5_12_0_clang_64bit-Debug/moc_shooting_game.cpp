...
#include "../final_game/shooting_game.h"
...
void shooting_game::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (shooting_game::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&shooting_game::won_game)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (shooting_game::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&shooting_game::lose_game)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject shooting_game::staticMetaObject = { {
    &QGraphicsView::staticMetaObject,
    qt_meta_stringdata_shooting_game.data,
    qt_meta_data_shooting_game,
    qt_static_metacall,
    nullptr,
    nullptr
} };
