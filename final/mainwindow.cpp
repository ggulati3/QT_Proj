...
*/
    QObject::connect(instruc_1->back, SIGNAL(clicked()), this, SLOT(go_to_main()));
    QObject::connect(instruc_2->back, SIGNAL(clicked()), this, SLOT(go_to_main()));
    QObject::connect(instruc_3->back, SIGNAL(clicked()), this, SLOT(go_to_main()));
    QObject::connect(instruc_1->start, SIGNAL(clicked()), this, SLOT(go_to_gameone()));
    QObject::connect(instruc_2->start, SIGNAL(clicked()), this, SLOT(go_to_gametwo()));
    QObject::connect(instruc_3->start, SIGNAL(clicked()), this, SLOT(go_to_gamethree()));
    ...
    QObject::connect(instructions->start, SIGNAL(clicked()), this, SLOT(go_to_main()));
}
