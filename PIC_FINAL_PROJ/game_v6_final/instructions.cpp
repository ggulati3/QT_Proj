...
instruc::instruc():instructions (){
    instruction = new QLabel("Welcome to the Arcade! \n \n"
                             ...
                             "Clicking on the first door will take you inside to the first \n"
                             "minigame. You have three lives for the entire course of the game. \n"
                             "To recieve a new key you must beat the minigame behind the first \n"
                             "door. Each new key opens another door and you will face a new \n"
                             "challenge inside. \n \n"
...
instruction_game2::instruction_game2():instructions ()  {
    instruction = new QLabel("Instructions: Welcome to Tic Tac Toe! \n"
                             "The object is to get three in a row (horizontally, vertically, \n"
...
instruction_game3::instruction_game3():instructions ()  {
    instruction = new QLabel("Instructions: Welcome to Alien Invasion! \n"
                             ...
                             "Good Luck!\n\n"
                             ""
                             "(Must first click in the white area at the start of the game to \n"
                             "activate movement keys.)");
    instruction->setFont(*f);
    instruction->setStyleSheet("color: white");
    layout->addWidget(instruction);
    layout->addWidget(start);
