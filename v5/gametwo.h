...
public slots:
    void mark() {setText("X"); setStyleSheet("font: bold; background-color: blue;");}                //puts an "X" on the pushbutton
...
public:
    ...
    QPushButton* win_game_button = new QPushButton("Congrats you won!");
